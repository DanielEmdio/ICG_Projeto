...
Command: npx gltfjsx@6.2.16 need_some_space.glb 
...
export function Galaxy(props) {
  const { nodes, materials } = useGLTF('assets/models/need_some_space.glb')
  return (
...
useGLTF.preload('assets/models/need_some_space.glb')
